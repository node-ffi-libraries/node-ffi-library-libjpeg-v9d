...
exports.functions = new FFI.Library(null, {
  ...
  jpeg_default_qtables: [ref.types.void, [j_compress_ptr, ref.types.uint32]],
  ...
  jpeg_suppress_tables: [ref.types.void, [j_compress_ptr, ref.types.uint32]],
  jpeg_alloc_quant_table: [JQUANT_TBLPtr, [j_common_ptr]],
  jpeg_alloc_huff_table: [JHUFF_TBLPtr, [j_common_ptr]],
  jpeg_std_huff_table: [
    JHUFF_TBLPtr,
    [j_common_ptr, ref.types.uint32, ref.types.int32],
  ],
  jpeg_start_compress: [ref.types.void, [j_compress_ptr, ref.types.uint32]],
  ...
  jpeg_read_header: [ref.types.int32, [j_decompress_ptr, ref.types.uint32]],
  jpeg_start_decompress: [ref.types.uint32, [j_decompress_ptr]],
  jpeg_read_scanlines: [
    ref.types.uint32,
    [j_decompress_ptr, JSAMPARRAY, ref.types.uint32],
  ],
  jpeg_finish_decompress: [ref.types.uint32, [j_decompress_ptr]],
  jpeg_read_raw_data: [
    ref.types.uint32,
    [j_decompress_ptr, JSAMPIMAGE, ref.types.uint32],
  ],
  jpeg_has_multiple_scans: [ref.types.uint32, [j_decompress_ptr]],
  jpeg_start_output: [ref.types.uint32, [j_decompress_ptr, ref.types.int32]],
  jpeg_finish_output: [ref.types.uint32, [j_decompress_ptr]],
  jpeg_input_complete: [ref.types.uint32, [j_decompress_ptr]],
